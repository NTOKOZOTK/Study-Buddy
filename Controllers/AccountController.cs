...
namespace Study_Buddy.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    {
                        return RedirectToAction("landingS","Students");  
                    }
                    else if  (UserManager.IsInRole(userId, "Admin"))
                    {
                        return RedirectToAction("landingA", "Students");
                    }
                    else if (UserManager.IsInRole(userId, "Tutor"))
                    {
                        return RedirectToAction("landingT", "Tutors");
                    }
        ...
        public async Task<ActionResult> RegisterRole(RegisterViewModel model,ApplicationUser user)
        {
            ...
            //assign roles
            await this.UserManager.AddToRolesAsync(updatedId, model.Name);
            return RedirectToAction("Index", "Home");
        }
